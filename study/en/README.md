...
| [07 The relation R](07-relation-r.md) | the structures of level $`(k, \eta)`$, the definition of $`R`$, the (top, layer, index) recursion, the defining equation, strictness, weakening | README "The relation R"; notes/01-design.md §3.3–§3.8, §4.1–§4.4 |
