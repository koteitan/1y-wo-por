...
このノートは、ラベルに使う順序数と、ラベルの上限に使う $`\omega_1`$ を説明する。ラベルとは、展開の停止性の証明で使う順序数のことである。ラベルは [02](02-well-founded.md) §6 と [06](06-combinatorial-layer.md) §2 で定義する。使う事実は §5 の正則性と §6 の数え上げである。
