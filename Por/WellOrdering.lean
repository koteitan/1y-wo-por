/-
  End-to-end check: the Carlson-style label model discharges every semantic hypothesis of
  `OneY.RootIndexed.actual_expansion_wellFounded` (Phyrion, 1Y-Well-Ordering-Lean, Apache-2.0),
  giving the four final 1-Y theorems with no constructible universe and no `Adequate`.
  Helpers for tuples and for ω₁ are adapted from bms-elem-pattern (Pattern/Basic.lean,
  Pattern/Chain.lean).
-/
import Mathlib
...
theorem generated_strictWellOrder :
    Por.StrictWellOrder OneY.Numeric.GeneratedExpr
      OneY.Numeric.GeneratedLt :=
...
theorem descendants_strictWellOrder (s : ZeroY.Expr) :
    Por.StrictWellOrder (OneY.Numeric.Descendant s)
      OneY.Numeric.DescendantLt :=
...
#print axioms Por.Final.finiteReflection
#print axioms Por.Final.initial_all
#print axioms Por.Final.expansion_wellFounded
#print axioms Por.Final.generated_strictWellOrder
#print axioms Por.Final.descendants_strictWellOrder
#print axioms Por.Final.expansion_chain_reaches_empty
